...
export const settingsFieldDefs = {
  ...
  taxShipping: [
    ['taxRate', 'Tax rate (%)', '0'],
    ['shippingFlatRate', 'Flat shipping rate (PKR)', '0'],
    ['freeShippingThreshold', 'Free shipping over (PKR, 0 = disabled)', '0'],
  ],
  announcement: [
    ['announcementText', 'Announcement text', 'e.g. Eid Sale — 10% off all inverters this week'],
    ['announcementLink', 'Link (optional)', '/#products'],
  ],
  banners: [],
  spotlight: [],
  smtp: [
