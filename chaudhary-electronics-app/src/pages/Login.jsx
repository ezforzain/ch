 ...
 * real backend (server/src/controllers/auth.controller.js). Google/GitHub stay
 * "coming soon" placeholders — there's no OAuth app wired up yet, so pretending
 * they work would be dishonest. "Create account" links to the real /register page.
 */
